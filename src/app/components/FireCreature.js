...
const FireCreature = () => {
  return (
     <div >
        ...
        <div className='p-3 w-[350px] pmx:w-[390px] ms-[12px] rounded-lg mt-7 pmx:mt-10 p4m:ms-5 p4m:mt-14 spm:mt-14 spm:ms-5' style={{ background: "linear-gradient(to bottom, #96B4B4, #414E4E)" }}>
        ...
        <div>
            <img src='/images/Flameexpand2.png' alt='fire creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5'>
            <p className='font-bold ms-[113px] me-24 pmx:ms-[128px] pmx:me-28 text-orange-600 uppercase'>fire creature</p>
        </div>
        ...
        <div className='bg-orange-500 w-[80px] rounded-full ms-[145px] pmx:ms-[165px] mt-[10px] pmx:mt-4 border-[1px] border-white spm:ms-[155px] p4m:ms-[175px]'>
