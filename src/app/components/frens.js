...
const Frends = () => {
  return (
    <div
      className="mt-5 uppercase p4m:ms-2 flex flex-col items-center"
      id="frens"
    >
      <div className="text-center text-white">
        ...
        <p className="text-[45px] pmx:text-[80px] spm:text-[80px]" id="nums">
          35
        </p>
      ...
      <div className="mt-5 text-[14px] pmx:text-[17px] spm:text-[17px] font-semibold flex flex-col items-center ">
        <div className="flex border-2 border-orange-600 rounded-full p-1 w-[340px] mt-2 pmx:w-[377px] pmx:p-3 spm:w-[350px] spm:p-3">
          <p className="text-[16px] text-orange-600 font-bold leading-7 ms-2">
            user a
          </p>
        ...
        <div className="flex border-2 border-orange-600 rounded-full p-1 w-[340px] mt-2 pmx:w-[377px] pmx:p-3 spm:w-[350px] spm:p-3">
          <p className="text-[16px] text-orange-600 font-bold ms-2 flex-1 items-center">
            user d
          </p>
          <div className="ms-[195px] pmx:ms-[220px] spm:ms-[190px]">
            <img src="/images/CoinCNB.png" alt="coin" className="w-8 h-6" />
        ...
        <div className="flex">
          ...
          <div className="border-2 border-white rounded-full p- text-[20px] pmx:text-[35px] w-12 mt-2 pmx:mt-4 ms-2 pmx:w-20 spm:mt-4 spm:ms-2 spm:w-[70px] spm:text-[35px] flex flex-col items-center">
