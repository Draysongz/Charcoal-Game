...
const LightningCreature = () => {
  return (
     <div >
        ...
        <div>
            <img src='/images/sojo.png' alt='lightning creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5'>
            <p className='font-bold ms-[85px] me-20 pmx:ms-[105px] pmx:me-20 text-orange-600 uppercase'>lightning creature</p>
        </div>
...
export default LightningCreature