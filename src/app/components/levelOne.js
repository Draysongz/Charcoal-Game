        ...
        <div>
            ...
            <div className='bg-orange-600 mt-3 w-[330px] rounded-full ms-6 border-2 border-white flex pmx:w-[370px] pmx:py-1 spm:w-[345px]'>
                <div className='ms-3 p-[3px]'>
                    ...
                    <span className='absolute left-[70px] top-[342px] text-[12px] pmx:top-[520px] spm:top-[486px] p4m:left-[85px]'>100 coin</span>
                    <span className='text-[12px] font-bold ms-[270px] absolute top-[330px] pmx:top-[509px] pmx:ms-[300px] spm:top-[477px]'>120</span>
                </div>
            </div>
