    ...
    <div className='mt-5 pmx:mt-10 spm:mt-10 p4m:ms-2 lvs'>
        <div className='mb-2'>
            <div className='text-center'>
                <h3 className='uppercase font-bold pmx:mb-1 spm:mb-1'>level 1</h3>
               <div className='bg-orange-600 w-40 rounded-[40px] p-2 ms-[108px] pmx:w-[300px] pmx:ms-[58px] spm:w-[290px] spm:ms-[50px] borImg'>
                     <img src='/images/level4.png' alt='level one' className='w-36 rounded-[40px] pmx:w-[290px] spm:w-[280px]' />
               </div>
            </div>
        ...
        <div>
            <h3 className='uppercase text-center font-bold'>fire ascent</h3>
            <div className='bg-orange-600 mt-3 w-[330px] rounded-full ms-6 border-2 border-white flex pmx:w-[370px] pmx:py-1 spm:w-[345px]'>
                <div className='ms-3 p-[3px]'>
                    ...
                    <span className='absolute left-[70px] top-[342px] text-[12px] pmx:top-[520px] spm:top-[486px] p4m:left-[85px] coinBal'>100 coin</span>
                    <span className='text-[12px] font-bold ms-[270px] absolute top-[330px] pmx:top-[509px] pmx:ms-[300px] spm:top-[477px] coinBal2'>120</span>
                </div>
            </div>
