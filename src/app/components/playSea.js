...
const PlaySea = () => {
  return (
    ...
    spm:space-x-4 p4m:space-x-5 forest'>
        <div className='rounded-xl p-3 w-[170px] pmx:w-[190px] spm:w-[175px]' style={{ background: "linear-gradient(to bottom, #6AE5F3, #1D4D53)" }}>
            <div className=''>
                <img src='/images/WaterFairy.png' alt='water fairy' className='rounded-md h-[95px] w-[150px] pmx:h-[130px] pmx:w-[170px] spm:h-[130px] spm:w-[170px] Imgs' />
            </div>
        ...
        <div className='rounded-xl p-3 w-[170px] pmx:w-[190px] spm:w-[175px]' style={{ background: "linear-gradient(to bottom, #6AE5F3, #1D4D53)" }}>
              <div className='rounded-md'>
                  <img src='/images/wolf.png' alt='wolf' className='rounded-md h-[95px] pmx:h-[130px] w-[150px] pmx:w-[170px] spm:h-[130px] spm:w-[170px] Imgs' />
              </div>
        <div className='text-center text-orange-600 font-bold uppercase pmx:text-[20px] pmx:mb-1 spm:text-[20px] spm:mb-1 textH'>
            <p>ice</p>
            <p className='-mt-[8px]'>creature</p>
