...
const Airdrop = () => {
  ...
  return (
    <div className="mt-14 pmx:mt-20 text-center p-5">
      <h3 className="text-[25px] uppercase mb-2 text">airdrop</h3>
      <div className="bg-gray-800 border-2 border-orange-600 uppercase p-5">
        ...
        <div className="bg-orange-500 border-2 border-white rounded-full p-2">
          <div
            className="flex flex-auto items-center justify-center text-white"
            onClick={onOpen}
          >
        ...
        <DrawerContent className="rounded-t-3xl p-0">
          ...
          <div id="wallet">
            <div className="text-center text-white bg-black flex flex-col items-center pt-5 pb-10">
              ...
              />
              <h3 className="text-orange-600 text-[20px] pmx:text-[30px] uppercase font-bold spm:text-[30px]">
