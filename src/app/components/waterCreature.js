...
const WaterCreature = () => {
  return (
     <div className='play'>
        ...
        <div className='Img'>
            <img src='/images/waterFairy.png' alt='water creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5 pmx:ms-[12px]'>
            <p className='font-bold ms-[105px] me-24 pmx:ms-[117px] pmx:me-28 text-orange-600 uppercase'>water creature</p>
        </div>
