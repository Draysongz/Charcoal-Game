...
const PlayForest = () => {
  return (
    <div className='flex mt-4 space-x-3 spm:space-x-4 p4m:space-x-5 forest'>
        <div className='rounded-xl p-3 w-[170px] pmx:w-[190px] spm:w-[175px]' style={{ background: "linear-gradient(to bottom, #5FBB98, #2B5545)" }}>
            <div className=''>
                <img src='/images/Frog2.png' alt='frog king' className='rounded-md h-[95px] pmx:h-[130px] w-[150px] pmx:w-[170px] spm:h-[130px] spm:w-[170px] Imgs' style={{ backgroundSize: "100% 100%" }} />
            </div>
