...
const PlaySea = () => {
  return (
    <div className='flex mt-4 space-x-3 spm:space-x-4 p4m:space-x-5'>
        <div className='rounded-xl p-3 w-[170px] pmx:w-[190px] spm:w-[175px]' style={{ background: "linear-gradient(to bottom, #5FBB98, #2B5545)" }}>
            <div className=''>
                <img src='/images/Frog2.png' alt='frog king' className='rounded-md h-[95px] pmx:h-[130px] w-[150px] pmx:w-[170px] spm:h-[130px] spm:w-[170px]' style={{ backgroundSize: "100% 100%" }} />
            </div>
        ...
        <div className='text-center uppercase bg-gray-500 bg-opacity-45 w-[60px] py-[2px] rounded-full text-[9px] ms-[43px] mb-2 pmx:ms-[52px] pmx:text-[12px] spm:ms-[46px] spm:text-[12px]'>
            owned
        </div>
        ...
        <div className='rounded-xl p-3 w-[170px] pmx:w-[190px] spm:w-[175px]' style={{ background: "linear-gradient(to bottom, #5FBB98, #2B5545)" }}>
              <div className='rounded-md'>
                  <img src='/images/EarthFairy.png' alt='earth fairy' className='rounded-md h-[95px] pmx:h-[130px] w-[150px] pmx:w-[170px] blur-sm spm:h-[130px] spm:w-[170px]' />
              </div>
        ...
        <div className='flex uppercase text-[11px] pmx:text-[13px] font-bold border-t-2 border-white'>
            <span className='text-orange-600 me-5 mt-1 pm'>pwr 1/ 10</span> 
                <span className='border-e-2 border-white me-5 h-4 mt-1'></span>
                <img src='/images/targetNB.png' alt='target' className='w-5 h-5 mt-1 me-1' />
            <span className='mt-[5px] '>
                20k
