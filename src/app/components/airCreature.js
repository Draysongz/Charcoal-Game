...
const AirCreature = () => {
  return (
     <div >
        ...
        <div className='p-3 w-[350px] pmx:w-[390px] ms-[12px] rounded-lg mt-7 pmx:mt-10 p4m:ms-5 p4m:mt-14 spm:mt-14 spm:ms-5' style={{ background: "linear-gradient(to bottom, #D98480, #734644)" }}>
        ...
        <div>
            <img src='/images/seadragon.png' alt='air creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5'>
            <p className='font-bold ms-[117px] me-24 pmx:ms-[133px] pmx:me-28 text-orange-600 uppercase'>Air creature</p>
        </div>
        ...
        <div className='bg-indigo-300 w-[180px] rounded-full ms-[98px] pmx:ms-[118px] mt-3 pmx:mt-4 spm:ms-[105px] p4m:ms-[130px]'>
            <div className='p-2 font-bold text-[12px] text-center uppercase'>
                <p>you own this creature</p>
            </div>
        </div>
