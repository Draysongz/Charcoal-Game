  ...
  return (
    ...
    <div className='mb-2'>
        <div className='text-center'>
            <h3 className='uppercase font-bold pmx:mb-1 spm:mb-1'>level 2</h3>
            <div className='bg-orange-600 w-40 rounded-[40px] p-2 ms-[108px] pmx:w-[300px] pmx:ms-[58px] spm:w-[290px] spm:ms-[50px] borImg'>
                     <img src='/images/level2.png' alt='level one' className='w-36 rounded-[40px] pmx:w-[290px] spm:w-[280px]' />
               </div>
            </div>
        ...
        <div>
            <h3 className='uppercase text-center font-bold'>ember cup</h3>
