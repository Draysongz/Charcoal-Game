...
const LevelTwo = () => {
  return (
    <div className="flex flex-col items-center mt-5 pmx:mt-10 spm:mt-10 lvs overflow-y-auto"
      style={{ height: "calc(90vh - 80px)" }}>      <div className="mb-2 flex flex-col items-center">
