...
const EarthCreature = () => {
  return (
     <div >
        ...
        <div>
            <img src='/images/antenna.png' alt='earth creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5'>
            <p className='font-bold ms-[104px] me-24 pmx:ms-[120px] pmx:me-28 text-orange-600 uppercase'>earth creature</p>
        </div>
        ...
        <div className='bg-indigo-300 w-[80px] rounded-full ms-[145px] pmx:ms-[165px] mt-3 pmx:mt-4 spm:ms-[155px] p4m:ms-[175px]'>
