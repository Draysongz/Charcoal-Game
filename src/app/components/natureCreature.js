...
const NatureCreature = () => {
  return (
     <div className='play'>
        ...
        <div className='p-3 w-[350px] pmx:w-[390px] ms-[12px] rounded-lg mt-7 pmx:mt-10 p4m:ms-5 p4m:mt-14 spm:mt-14 spm:ms-5 pmx:ms-[12px]' 
        ...
        <div className='Img'>
            <img src='/images/earthFairy.png' alt='nature creature' className='w-full h-[140px] pmx:h-[250px] spm:h-[250px] rounded-b-md' />
        </div>
        </div>

        <div className='flex w-[350px] pmx:w-[390px] ms-[12px] bg-gray-700 mt-2 rounded-full p-1 pmx:p-2 p4m:ms-5 spm:ms-5 pmx:ms-[12px]'>
            <p className='font-bold ms-[98px] me-24 pmx:ms-[115px] pmx:me-28 text-orange-600 uppercase'>Nature creature</p>
        </div>
        ...
        <div className='bg-indigo-300 w-[150px] rounded-full ms-[115px] pmx:ms-[130px] mt-3 pmx:mt-4 spm:ms-[120px] p4m:ms-[140px]'>
            <div className='p-2 font-bold text-[12px] text-center uppercase'>
                <p>level 10 rquired</p>
            </div>
        </div>
