...
const LanchTwo = () => {
  return (
    <div className='min-h-screen' style={{ backgroundImage: "linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.9)), url('/images/frog 1.png')", backgroundSize: "100% 100%" }}>
        <div className='text-center grid-rows-6 fixed bottom-8 justify-center items-center ms-[75px] pmx:ms-[100px]'>
            ...
            <div className='flex space-x-6 text-[20px] mt-1 ms-12 pmx:ms'>
