...
const SlotMachine = () => {
  ...
  return (
    <div
      className="min-h-screen slot relative flex flex-col"
      style={{
        backgroundImage: "url('/images/Slotmachine2.png')",
    ...
    >
      ...
      <div className="absolute top-[225px] left-[130px] pmx:top-[300px] pmx:left-[130px] spm:top-[280px] spm:left-[120px] p4m:top-[310px] p4m:left-[130px] winni">
        <img
          src="/images/WIN.png"
          alt="win"
          className="h-[60px] pmx:h-[80px] spm:h-[80px] p4m:h-[90px]"
        />
      </div>

      <span className="absolute flex top-[57.5%] bg-white mx-[35%]">
        <img
      ...
      <Box>
        <img
          src="/images/PBar.png"
          alt="progress bar"
          className="mt-[15px] ms-[80px] pmx:mt-[20px] pmx:ms-[90px] pmx:w-[220px] spm:-mt-[1px] spm:w-[220px] p4m:mt-[26px] p4m:w-[238px] Pbar"
        />
        <img
          src="/images/Bar.png"
          alt="bar"
          className="absolute top-[486px] left-[137px] pmx:top-[657px] pmx:left-[160px] spm:top-[616.5px] spm:left-[148px] p4m:top-[684px] p4m:left-[170px] bar"
        />
      </Box>
      ...
      <div className="flex gap-[60px] ms-[70px] mt-[20px] pmx:mt-[43px] pmx:gap-[64px] spm:mt-[35px] spm:gap-[65px] p4m:mt-[45px] p4m:gap-[71px] bet-A">
        <div>
          <img
            ...
            alt="betx"
            className="w-[53px] h-[48px] pmx:w-[70px]"
          />
        </div>
        <div>
          <button
        ...
        <div>
          <img
            ...
            alt="auto spin"
            className={`w-[74px] h-[47px] pmx:w-[80px] ${
